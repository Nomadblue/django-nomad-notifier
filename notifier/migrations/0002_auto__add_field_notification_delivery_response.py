...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notification.delivery_response'
        db.add_column(u'notifier_notification', 'delivery_response',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notification.delivery_response'
        db.delete_column(u'notifier_notification', 'delivery_response')
    ...
    models = {
        ...
        u'notifier.notification': {
            ...
            'delivery_response': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
